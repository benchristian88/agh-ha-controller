    ...
    <PageContainer size="wide">
      ...
      >
        <p>
          ...
          Statistics, Query Log, DNS probe, HA event, and notification-delivery
          history. Browser sessions and release caches are excluded from both.
        </p>
        <form className="form-stack" onSubmit={(event) => void create(event)}>
          ...
          <button className="button" disabled={busy} type="submit">
            {busy ? "Creating encrypted backup…" : "Create and download backup"}
          </button>
        </form>
        {created && (
      ...
      >
        <form className="form-stack" onSubmit={(event) => void validate(event)}>
