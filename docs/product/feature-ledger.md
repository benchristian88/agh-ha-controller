...
| Release 0.4 UI | Implemented | Seven nested settings routes, responsive accessible forms, schema gate, partial refresh, TLS and DHCP safeguards; rewrites, clients, and static leases avoid secure-context-only UI identifiers | Browser accessibility/visual smoke |
